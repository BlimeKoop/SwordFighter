...
public class Slice : MonoBehaviour
{
    ...
    /// </summary>
    /// <param name="sliceNormal">The cut plane normal vector in world coordinates.</param>
    /// <param name="sliceOrigin">The cut plane origin in world coordinates.</param>
    public void ComputeSlice(Vector3 sliceNormal, Vector3 sliceOrigin)
    {
