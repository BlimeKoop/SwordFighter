...
public class Fracture : MonoBehaviour
{
	...
	void Awake()
	{
		triggerOptions = triggerOptions == null ? new TriggerOptions() : triggerOptions;
		fractureOptions = fractureOptions == null ? new FractureOptions() : fractureOptions;
		refractureOptions = refractureOptions == null ? new RefractureOptions() : refractureOptions;
		callbackOptions = callbackOptions == null ? new CallbackOptions() : callbackOptions;
