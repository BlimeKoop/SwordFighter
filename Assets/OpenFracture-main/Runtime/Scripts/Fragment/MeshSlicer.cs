...
public static class MeshSlicer
{
                             ...
                             out FragmentData bottomSlice)
    {
		...
		// World to object space conversion
		Vector3 objectScale = sourceObject.transform.lossyScale;
		
		sliceNormal = new Vector3(
			sliceNormal.x * objectScale.x,
			sliceNormal.y * objectScale.y,
			sliceNormal.z * objectScale.z);
			
		sliceOrigin = sourceObject.transform.InverseTransformPoint(sliceOrigin);
